...
const ConfigForm: React.FC<ConfigFormProps> = ({ onSubmit }) => {
  ...
  return (
      <form onSubmit={submit}>
        ...
        <input ref={register} name="serverIP" required={true} />
        <label htmlFor="portOffset">Port Offset</label>
        <input ref={register} name="portOffset" type="number" min="0" max="16" step="1"/>
        <label htmlFor="channels">Channels</label>
        <input ref={register} name="channels" required={true} type="number" min="1" max="16" step="1" />
        ...
        <input ref={register} name="queueBufferLength" type="number" min="0" max="50" step="1" />
